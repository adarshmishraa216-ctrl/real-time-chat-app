...
import { formatMessageTime } from "../Library/utils";   // ✅ fixed function name
import { ChatContext } from "../../context/chatcontext"; // ✅ fixed import
import { AuthContext } from "../../context/authcontext";
import toast from "react-hot-toast"; // ✅ needed for toast.error
...
const ChatContainer = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    await sendMessage({ text: input.trim() }); // ✅ fixed
